...
const PROJECTS = [
    ...
    },
    {
        ...
        desc: 'Created a VS Code inspired portfolio website using React.js and TailwindCSS. The website replicated the display screen of a Linux operating system with a VS Code IDE opened inside. The main features of VS Code IDE were replaced to showcase about the portfolio of the person. You are currently viewing this website!',
    ...
    {
        title: 'Datacalibre Website',
        desc: 'Created a modern, responsive website for Datacalibre, a digital agency offering services in Full Stack Development, AI Solutions, SEO, and Branding. Built with React.js and TailwindCSS, the site features a clean design, intuitive navigation, and showcases the agency’s portfolio and services effectively.',
        github: null,
        liveLink: null,
        tags: ['React.js', 'TailwindCSS', 'Netlify'],
        categories: ['Web Development'],
    },
    {
        ...
        desc: 'Built a sleek, SEO-optimized portfolio website for an SEO specialist using React.js and TailwindCSS. The site features a clean design, fast load times, and is structured to rank well in search engines, effectively showcasing the specialist’s skills, services, and case studies.',
        github: null,
        liveLink: 'https://maazsatti.netlify.app',
        tags: ['React.js', 'TailwindCSS', 'Netlify'],
        categories: ['Web Development'],
    },
    {
